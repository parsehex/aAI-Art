<template>
  <div class="flex items-center gap-4">
    <div class="max-w-sm">
      ...
      <p class="w-full px-2 whitespace-pre-line max-h-32 overflow-auto" :class="[viewingSvg ? '' : 'invisible', 'bg-gray-800 p-1 rounded-md shadow-md']">
        Selected SVG
      </p>
      <p class="w-full px-2 whitespace-pre-line max-h-32 overflow-auto" :class="[viewingSvg ? '' : 'invisible', 'bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-700 space-y-4 w-80 mx-auto']">
        {{ viewingSvg }}
      </p>
    </div>
